...
readonly wfxexec="/usr/bin/waterfox-alpha" # Symbolic link to main executable
readonly wfxdesktop="/usr/share/applications/waterfox-alpha.desktop" # Desktop entry file
readonly wfxbinpath="/usr/lib64/waterfox-alpha/waterfox" # Main executable
readonly wfxiconpath="/usr/lib64/waterfox-alpha/browser/chrome/icons/default/default256.png" # Desktop entry default icon. Available: default16.png  default22.png  default24.png  default256.png  default32.png  default48.png
...
function wfx_create_desktop_file() {
    ...
    if [[ ! -f "${wfxdesktop}" ]]
    then
        printf "\nCreating the waterfox-alpha.desktop file...\n"
        ...
        \tee --ignore-interrupts "${wfxdesktop}" <<WFOXALPHA
[Desktop Entry]
Name=Waterfox Alpha
